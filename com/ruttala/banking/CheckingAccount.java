...
*	Date: October, 2013														  *							
*	Modified By: Himaja Suman ruttala                                         *
*	Date: September, 2015											      	  *
*******************************************************************************/
	...
	public boolean deposit(String ChkAcctNumber, float amount) {
		try {
			...
			while (Rslt.next()) {
				Balance = Rslt.getFloat(1);
				System.out
						.println("The Current Balance in Checking Account is %f"
								+ Balance);
				...
				System.out
						.println("The Current Balance in Checking Account after Depositing %f is %f"
								+ Balance);
			}
			Stmt.close();
			ToDB.closeConn();
